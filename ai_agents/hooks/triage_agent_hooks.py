...
class triage_agent_hooks(AgentHooks[AppContext]):
    """Hooks para el Agente de Conocimiento."""
...
#        pass
    ...
    async def on_start (
        ...
        """Se ejecuta cada vez que este agente es invocado"""
        print("triage START of context agent hooks")
        milisecond = time.perf_counter()
        debugging_obj = {
            "event": "agent_start",
            "agent_name": agent.name,
